...
```
cd existing_repo
git remote add origin https://gitlab.com/saksham-group7553924/ai-builder-project.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/saksham-group7553924/ai-builder-project/-/settings/integrations)
